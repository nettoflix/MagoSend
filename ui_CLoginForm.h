...
#ifndef QT_NO_TOOLTIP
        le_user->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        le_user->setPlaceholderText(QApplication::translate("CLoginForm", "usu\303\241rio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        le_password->setToolTip(QApplication::translate("CLoginForm", "<html><head/><body><p>senha</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP

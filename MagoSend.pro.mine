...
win32 {
        ...
        #-----------------------------------------------------------------------
        #FFMpeg 64bits(Windows)...
        #-----------------------------------------------------------------------
        FFFMPEG_DIR =                       ../ffmpeg_decoder/trunk/ffmpeg_decoder_with_yuv/lib/ffmpeg/win64_2018
        FFFMPEG_LIBRARY_DIR =               $${FFFMPEG_DIR}/library
        FFFMPEG_INCLUDE_DIR =               $${FFFMPEG_DIR}/include
        INCLUDEPATH +=                      $$FFFMPEG_INCLUDE_DIR
        LIBS +=                             -L$$FFFMPEG_LIBRARY_DIR \
                                            -lavutil \
                                            -lavcodec \
                                            -lavformat \
                                            -lswscale \
